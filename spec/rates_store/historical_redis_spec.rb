    ...
    describe HistoricalRedis do
      ...
      describe '#add_rates' do
        let(:expected_stored_hash_usd) do
          {
            '2015-09-10' => '0.11111E0',
            '2015-09-11' => '0.22222E0',
            '2015-09-12' => '0.33333E0'
          }
        end
        let(:expected_stored_hash_gbp) do
          {
            '2015-09-10' => '0.44444E0',
            '2015-09-11' => '0.55555E0',
            '2015-09-12' => '0.66666E0'
          }
        end
        let(:expected_stored_hash_vnd) do
          {
            '2015-09-10' => '0.77777E0',
            '2015-09-11' => '0.88888E0',
            '2015-09-12' => '0.99999E0'
          }
        end
